...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: v1spCvImucZT/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__de7Zh)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__iayi5)}
              role={"img"}
            />
          ),
