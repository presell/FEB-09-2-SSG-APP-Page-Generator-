...
import sty from "./PlasmicEditable.module.css"; // plasmic-import: zr5iTh4YS3wu/css
    ...
    >
      <div
        className={classNames(
          ...
          "editableText",
          {
            [sty.freeBoxeditEnabled__lXxfgxxdHk]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      <div
        className={classNames(
          ...
          "textEditor",
          {
            [sty.freeBoxeditEnabled__vAzruxxdHk]: hasVariant(
              $state,
              "editEnabled",
              "editEnabled"
            )
      ...
      >
        {(hasVariant($state, "editEnabled", "editEnabled") ? true : false)
          ? renderPlasmicSlot({
              defaultContents: (
                <TextInput
                  className={classNames("__wab_instance", sty.textInput__mnuk4)}
                  endIcon={null}
                  startIcon={null}
                />
              ),
